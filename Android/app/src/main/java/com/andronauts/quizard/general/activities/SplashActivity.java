...
import com.andronauts.quizard.faculty.activities.FacultyHomeActivity;
                    ...
                    public void run() {
                        if(currentUser != null){
                            if(prefs.isStudent()){
                                ...
                                Intent login = new Intent(SplashActivity.this, StudentHomeActivity.class);
                                startActivity(login);
                                finish();
                            }else{
                                Log.i("SPLASH SCREEN INTENT", "Not logged in");
                                Intent login = new Intent(SplashActivity.this, FacultyHomeActivity.class);
                                startActivity(login);
                                finish();
                            }
